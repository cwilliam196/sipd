   ...
   <!--/content-inner-->
	<div class="left-content">
		<div class="mother-grid-inner">
					...
					<ul>
						<li class="dropdown profile_details_drop">
							...
							<ul class="dropdown-menu drp-mnu">
								<li> <a href="{{ url('/home_user/profile')}}"><i class="fa fa-user"></i> Profile</a> </li>
			...
			<!--heder end here-->
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="{{url('/home_user')}}">Home</a> <i class="fa fa-angle-right"></i>@yield('title')</li>
			</ol>
